# functions/page-ai.py
# ============================================================
# ФУНКЦИЯ: page-ai.py
# Размер: 185 строк
# Путь в проекте: backend/page-ai/index.py
# Дата: 2026-08-31 11:59
# URL: https://functions.poehali.dev/d926cb75-6ab4-4a47-ae9a-d34cb788e27a
# ============================================================
...
5. Карточка (фото + заголовок + текст, фото слева/справа/сверху):
{"type":"card","id":"<id>","x":40,"y":80,"w":280,"h":120,"title":"Заголовок","text":"Описание","photoUrl":"","photoSide":"left|right|top|none","align":"left","zIndex":1}

6. Видео (YouTube, Vimeo, прямой URL или S3):
{"type":"video","id":"<id>","x":40,"y":80,"w":400,"h":225,"url":"","zIndex":1}

7. Прайс-лист / таблица цен:
{"type":"price","id":"<id>","x":40,"y":80,"w":360,"h":200,"title":"Наши цены","items":[{"icon":"✅","name":"Услуга","price":"от 1 000 ₽","desc":""}],"zIndex":1}

8. Цитата / отзыв:
{"type":"quote","id":"<id>","x":40,"y":80,"w":300,"h":120,"text":"Отличная работа!","author":"Иван И.","role":"Клиент","avatar":"","zIndex":1}
