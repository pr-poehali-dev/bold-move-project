...
АКТУАЛЬНЫЙ ПРАЙС (₽) — используй только эти цены:
...
ПРОФИЛЬ СТАНДАРТНЫЙ (за пог.м):
Стеновой ПВХ — 150
Стеновой алюминий — 200
Потолочный алюминий — 200

ТЕНЕВОЙ ПРОФИЛЬ (за пог.м):
EuroKRAAB стеновой — 2200
EuroKRAAB потолочный — 2600
Теневой Flexy KLASSIKA 140 — 1650 (теневой классик, классика)

ПАРЯЩИЙ ПРОФИЛЬ (за пог.м):
Парящий ПК-6 без рассеивателя — 1300
Flexy FLY 01 без рассеивателя — 1450
Flexy FLY 02 с рассеивателем — 1650 (по умолчанию если парящий не уточнён)

НИШИ ДЛЯ ШТОР (за пог.м):
БП-40 — 850
Sigma — 1400
Sigma LED — 1650
...
Под люстру крюк — 500
Под люстру планка — 700 (по умолчанию если тип не указан)
Под люстру крестовина — 1400
Краб (крестовина профиля) — 350/шт

ОСВЕЩЕНИЕ:
Светильник GX-53 + лампа — 400/шт
Диффузор для светильника — 250/шт
...
Монтаж профиля стандарт — 200/пог.м
Монтаж теневого профиля — 350/пог.м
Монтаж парящего профиля — 350/пог.м
Монтаж закладной — 350/шт
Монтаж светильников GX-53 — 500/шт
Монтаж разводки ГОСТ 0.75 — 700/шт (1 точка = 1.5 пог.м)
Монтаж ленты — 350/пог.м
Монтаж блока питания — 500/шт
Монтаж по керамической плитке — 500/пог.м
Монтаж бруса — 300/пог.м
Работы на высоте (до 4м) — 1500/шт
Работы на высоте (более 4м) — 3000/шт

ПРАВИЛА РАСЧЁТА:
- Периметр = 1.3 × площадь если клиент не указал
...
- Теневой/Парящий: их пог.м ВЫЧЕСТЬ из стандартного профиля
- Теневой классик / klassika / классика = Теневой Flexy KLASSIKA 140 — 1650 ₽/пог.м
- "Краб" или "Xм краб" — позиция "Краб (крестовина профиля)" 350 ₽/шт, количество = X
- Диффузор / дифузор = Диффузор для светильника 250 ₽/шт
- Плитка / керамогранит в монтаже = Монтаж по керамической плитке 500 ₽/пог.м
- "Высота имеется частями" / высота до 4м = Работы на высоте (до 4м) 1500 ₽, 1 шт
- Высота более 4м = Работы на высоте (более 4м) 3000 ₽, 1 шт
- "Без монта" / "без монтажа" у позиции = НЕ добавлять монтаж к этой позиции
- "Вклейка" у светильника = закладная Под светильник ∅90 (вклеивается в полотно)
- Лента кратна 5м: 6м → 2 катушки (10м)
...
- Не показывай формулу расчёта периметра клиенту
