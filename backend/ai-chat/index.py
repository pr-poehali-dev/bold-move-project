...
- "Краб" или "Xм краб" — позиция "Краб (крестовина профиля)", количество = X штук
- Диффузор / дифузор = Диффузор для светильника
- Плитка / керамогранит в монтаже = Монтаж по керамической плитке
- "Высота имеется частями" / высота до 4м = Работы на высоте (до 4м), 1 шт
- Высота более 4м = Работы на высоте (более 4м), 1 шт
- "Без монта" / "без монтажа" — НЕ добавлять монтаж к этой позиции
- "Вклейка" у светильника = закладная Под светильник ∅90
