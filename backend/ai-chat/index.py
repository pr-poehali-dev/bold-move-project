...
Пример: MSD Classic матовый  20 м² × 399 ₽ = 7 980 ₽
Пример: Стеновой алюминий  26 мп × 200 ₽ = 5 200 ₽
Пример: Под светильник ∅90  8 шт × 350 ₽ = 2 800 ₽
НИКОГДА не пиши "× количество" без цены. ВСЕГДА: кол-во × цена = итого.
