...
ЛЮСТРА (КРИТИЧНО — не игнорировать!):
- Если клиент сказал "люстра" / "одна люстра" / "две люстры" → ОБЯЗАТЕЛЬНО добавить "Под люстру планка"
- Количество = количеству люстр (обычно 1)
