...
export default function PricingPayment({ selectedId }: Props) {
  ...
  return (
    ...
    <div className="mt-8 px-2 text-center">
      <p className="text-[10px] leading-relaxed mx-auto max-w-3xl" style={{ color: "rgba(255,255,255,0.18)" }}>
        Информация на данной странице носит исключительно информационный характер и не является публичной офертой в соответствии со ст. 437 ГК РФ.
        Стоимость услуг, состав пакетов и условия предоставления доступа могут быть изменены в одностороннем порядке.
        Договор считается заключённым с момента подтверждения оплаты и активации доступа.
        ИП / ООО · Все права защищены.
      </p>
    </div>
    </section>
  );
