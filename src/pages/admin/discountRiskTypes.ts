...
Дай ТОЛЬКО фактический вывод: что означает балл {math_score}, какие позиции дают наибольший вклад в сложность. Без рекомендаций по скидке. Максимум 3 предложения.`,
  ...
  semantic: `Ты бригадир монтажников натяжных потолков с 15-летним опытом. Оцениваешь ТОЛЬКО то, что делает монтажник на объекте.

Список позиций сметы:
{items}

Твоя задача: оцени сложность МОНТАЖА (не производства, не логистики, не согласований).
...
- Качество материалов — это не его зона ответственности
- Согласование с клиентом, сроки поставок, коммуникации — это менеджер
- Электрическую безопасность, пожарную безопасность — это электрик
- Любые общие риски не связанные напрямую с монтажом

Что реально влияет на сложность монтажа:
- Количество уровней (двухуровневый, многоуровневый = сложнее)
- Радиусы, изогнутые формы
- Количество закладных под светильники и их расположение
- Парящий профиль, теневой профиль — точность стыков
- Монтаж ниш для штор — точность горизонтали
- Большая площадь одного полотна — нужен третий монтажник
- Стыковка нескольких полотен

Про светильники GX53, GX70 и аналогичные: они вставляются в готовое отверстие за 10 секунд. Сложность монтажа = 0. Не упоминай их как фактор сложности.

Оцени от 1 до 10 (целое число). Напиши 1-2 предложения — ТОЛЬКО про реальные монтажные нюансы из этого конкретного списка. Если объект простой — так и напиши прямо.
