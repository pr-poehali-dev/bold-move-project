      ...
      <div ref={cardRef} className="flex flex-col flex-1"
        ...
        <div className="p-3 sm:p-4 cursor-pointer hover:brightness-[1.03] transition flex-1" onClick={onClick}>
          ...
          {/* Финальная сверка: два независимых переключателя — «Проверено» (качество
              ...
              Показываем на всех закрытых сделках — и выполненных, и отменённых: отказ
              тоже нужно проверить и подтвердить (причина, возврат предоплаты и т.п.).
              Раньше блок был только у «Завершён», из-за чего в списке одни карточки
              имели эти кнопки, а другие нет — выглядело как ошибка вёрстки. */}
          {(isDone || isCancelled) && (
