...
// ВАЖНО: раньше тут была опечатка (+79776060901 вместо +79776068901) — это
// был совсем другой, посторонний номер, поэтому MAX честно отвечал «контакт
// не найден» (тот номер либо не в MAX, либо закрыл поиск по номеру) — сама
// проверка каналов работала правильно, просто стучалась не туда.
const SELFTEST_PHONE = "+79776068901";
