  ...
  return (
    <div className="bg-[#0b0b11] text-white font-rubik flex flex-col select-none" style={{ height: appHeight, overflow: "hidden" }}>
      ...
      <div className="flex-1 min-h-0 flex flex-col relative">
        ...
        <a href="https://t.me/JoniKras" target="_blank" rel="noreferrer"
          className="absolute bottom-20 right-3 z-30 flex items-center gap-2 pl-3 pr-3.5 py-2.5 rounded-full shadow-lg transition-all hover:scale-105 active:scale-95 group"
          ...
          <span className="text-white text-[11px] font-bold">Поддержка</span>
        </a>
