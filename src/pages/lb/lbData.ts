...
export const PROJECTS = [
  {
    ...
    tags: ["AI / LLM", "RAG", "Voice", "Python", "Telegram Bot", "FastAPI", "OpenAI", "PDF"],
    color: "#f97316",
  ...
  },
  {
    ...
    tags: ["React", "PostgreSQL", "Python", "Аналитика", "REST API", "Kanban", "P&L", "TypeScript"],
    color: "#8b5cf6",
  ...
  },
  {
    ...
    tags: ["Canvas API", "Geometry", "React", "PDF", "CAD", "TypeScript", "SVG", "Python"],
    color: "#06b6d4",
  ...
  },
  {
    ...
    tags: ["White-label", "Multi-tenant", "React", "Python", "PostgreSQL", "Telegram API", "REST API", "TypeScript"],
    color: "#10b981",
