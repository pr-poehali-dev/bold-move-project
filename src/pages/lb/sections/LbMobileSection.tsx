...
const MOBILE_SCREENS = [
  {
    ...
    color: "#f97316",
    img: "/assets/cdn/507e3a3f-22eb-41d0-b4a9-91c7063e5099.jpg",
  },
  {
    label: "CRM — Воронка",
    sub: "Заявки и финансы",
    color: "#8b5cf6",
    img: "/assets/cdn/b355fa9e-7615-40f9-8131-9f6dbb3311ae.jpg",
  },
  {
    label: "P&L по заказу",
    sub: "Затраты, доходы, маржа",
    color: "#10b981",
    img: "/assets/cdn/15478a1b-e4a1-406c-93b7-05f07653da6a.jpg",
  },
  {
    label: "CAD-построитель",
    sub: "Чертёж и материалы",
    color: "#06b6d4",
    img: "/assets/cdn/9b9146e8-90d5-4a1f-b978-2a4c40af7af9.jpg",
  },
  {
    label: "Мультикомнатный",
    sub: "Несколько комнат, одна смета",
    color: "#f59e0b",
    img: "/assets/cdn/8444e268-91e3-402f-9a48-88ffb3459a57.jpg",
  },
  {
    label: "Аналитика",
    sub: "Обзор, конверсии, KPI",
    color: "#a78bfa",
    img: "/assets/cdn/98f77739-d739-4bf0-8fe1-4c43e055b76f.jpg",
  },
  {
    label: "Финансы P&L",
    sub: "Доходы, расходы, прибыль",
    color: "#34d399",
    img: "/assets/cdn/0882c3c6-0cd9-4d0e-a406-a4e367e7150d.jpg",
  },
  {
    label: "Календарь",
    sub: "Замеры и монтажи на карте",
    color: "#fbbf24",
    img: "/assets/cdn/82f4b066-784b-4cbd-a290-a14082d16b96.jpg",
  },
];
