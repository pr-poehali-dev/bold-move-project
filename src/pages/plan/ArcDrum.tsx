...
// Параметры дуги
export const ITEM_H   = 62;
export const VISIBLE  = 5;
export const ARC_R    = 220;
export const TOTAL_H  = ITEM_H * VISIBLE;
export const PADDING  = ITEM_H * Math.floor(VISIBLE / 2);
...
export default function ArcDrum({ items, value, onChange, onClick, initialIdx, onSwipeRight }: Props) {
