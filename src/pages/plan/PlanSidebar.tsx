...
import type { PlanState, Segment, DiagonalDef, PlanSettings, DimLine, RoomParams, SidebarTab } from "./planTypes";
import {
...
// ─── Вкладка "Чертёж" ────────────────────────────────────────────────────────
function DrawingTab({ state, onChange }: Props) {
...
// ─── Вкладка "Расчёт" ────────────────────────────────────────────────────────
function CalcTab({ state }: { state: PlanState }) {
