...
export interface Permissions {
  ...
  // ── Уровень 3: Кастомные подэтапы (order_substatuses) внутри разрешённых
  // статусов — доп.ограничение поверх allowed_statuses. ID подэтапов (как строки).
  // Пустой массив / отсутствие ключа = ограничений нет (видны все подэтапы).
